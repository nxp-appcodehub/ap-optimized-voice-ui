...
xt-objcopy %xt_build_sysargs% -O binary %xt_exe% %bin_path%/dsp_text_%build_target%.bin ^
...
xt-objcopy %xt_build_sysargs% -O binary %xt_exe% %bin_path%/dsp_data_%build_target%.bin ^
...
xt-objcopy %xt_build_sysargs% -O binary %xt_exe% %bin_path%/dsp_reset_%build_target%.bin ^
