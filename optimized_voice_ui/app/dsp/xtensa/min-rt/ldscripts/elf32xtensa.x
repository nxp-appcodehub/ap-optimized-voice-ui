/* This linker script generated from xt-genldscripts.tpp for LSP c:\_ddm\dev\devices\MIMXRT595S\xtensa\min-rt */
/* Linker Script for default link */
MEMORY
{
  iram0_0_seg :                       	org = 0x00000000, len = 0x400
  iram1_0_seg :                       	org = 0x00080400, len = 0x17C
  iram1_1_seg :                       	org = 0x0008057C, len = 0x20
  iram1_2_seg :                       	org = 0x0008059C, len = 0x20
  iram1_3_seg :                       	org = 0x000805BC, len = 0x20
  iram1_4_seg :                       	org = 0x000805DC, len = 0x20
  iram1_5_seg :                       	org = 0x000805FC, len = 0x20
  iram1_6_seg :                       	org = 0x0008061C, len = 0x20
  iram1_7_seg :                       	org = 0x0008063C, len = 0x400
  iram1_8_seg :                       	org = 0x00080A3C, len = 0x1F5C4
  dram0_0_seg :                       	org = 0x00820000, len = 0x60000
  dram1_0_seg :                       	org = 0x00900000, len = 0xC0000
}
...
_memmap_mem_iram1_start = 0x080400;
_memmap_mem_iram1_end   = 0x0a0000;
_memmap_mem_dram0_start = 0x820000;
_memmap_mem_dram0_end   = 0x880000;
_memmap_mem_dram1_start = 0x900000;
_memmap_mem_dram1_end   = 0x9c0000;

/*  Memory segment boundary addresses:  */
_memmap_seg_iram0_0_start = 0x0;
_memmap_seg_iram0_0_max   = 0x400;
_memmap_seg_iram1_0_start = 0x080400;
_memmap_seg_iram1_0_max   = 0x08057c;
_memmap_seg_iram1_1_start = 0x08057c;
_memmap_seg_iram1_1_max   = 0x08059c;
_memmap_seg_iram1_2_start = 0x08059c;
_memmap_seg_iram1_2_max   = 0x0805bc;
_memmap_seg_iram1_3_start = 0x0805bc;
_memmap_seg_iram1_3_max   = 0x0805dc;
_memmap_seg_iram1_4_start = 0x0805dc;
_memmap_seg_iram1_4_max   = 0x0805fc;
_memmap_seg_iram1_5_start = 0x0805fc;
_memmap_seg_iram1_5_max   = 0x08061c;
_memmap_seg_iram1_6_start = 0x08061c;
_memmap_seg_iram1_6_max   = 0x08063c;
_memmap_seg_iram1_7_start = 0x08063c;
_memmap_seg_iram1_7_max   = 0x080a3c;
_memmap_seg_iram1_8_start = 0x080a3c;
_memmap_seg_iram1_8_max   = 0x0a0000;
_memmap_seg_dram0_0_start = 0x820000;
_memmap_seg_dram0_0_max   = 0x880000;
_memmap_seg_dram1_0_start = 0x900000;
_memmap_seg_dram1_0_max   = 0x9c0000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0x0);
PROVIDE(_memmap_vecbase_reset = 0x080400);
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x9c0000);
  _heap_sentry = 0x9c0000;
